...
import { FEE_MARKET_ETH_CHAINS, FEE_MARKET_POLKADOT_CHAINS } from "@feemarket/config";
import type { FeeMarketApiSection, FeeMarketPolkadotChain, FeeMarketChain } from "@feemarket/config";
